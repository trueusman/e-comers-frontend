...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-24 lg:bottom-6 left-1/2 -translate-x-1/2 z-[200] px-4">
      <div
        className="w-[300px] bg-white flex flex-col items-center justify-center px-7 py-5 gap-3 relative overflow-hidden"
        style={{ boxShadow: "2px 2px 20px rgba(0,0,0,0.062)" }}
      >
        {/* Cookie SVG */}
        <svg
          version="1.1"
        ...
        >
          <g>
            <path
              ...
              c-2.39-2.37-4.21-5.32-5.32-8.75c-1.51-4.66-1.69-10.2-0.18-16.32c-3.1-1.8-5.25-4.53-6.42-7.88
              c-1.06-3.05-1.28-6.59-0.61-10.35C47.27,5.95,34.3,11.36,24.41,20.18C13.74,29.69,6.66,43.15,5.84,58.29l0,0.05v0h0l-0.01,0.13v0
              C5.07,73.72,10.55,87.82,20.02,98.3c9.44,10.44,22.84,17.29,38,18.1l0.05,0h0v0l0.13,0.01h0
              c15.24,0.77,29.35-4.71,39.83-14.19c10.44-9.44,17.29-22.84,18.1-38l0-0.05v0h0l0.01-0.13v0c0.07-1.34,0.09-2.64,0.06-3.91
              C112.98,61.34,109.96,61.51,107.13,60.74L107.13,60.74z"
            />
          </g>
        </svg>

        {/* Text */}
        <p className="text-[1.2em] font-extrabold text-[rgb(26,26,26)]">We use cookies.</p>
        <p className="text-center text-[0.7em] font-semibold text-[rgb(99,99,99)]">
        ...
        <div className="flex flex-row gap-5">
          <button
            ...
            className="w-20 h-[30px] bg-[#3b82f6] hover:bg-[#2563eb] text-[rgb(241,241,241)] font-semibold rounded-[20px] border-none cursor-pointer transition-colors duration-200"
          >
            Allow
          </button>
          <button
            onClick={handleDecline}
            className="w-20 h-[30px] bg-[rgb(218,218,218)] hover:bg-[#ebebeb] text-[rgb(46,46,46)] font-semibold rounded-[20px] border-none cursor-pointer transition-colors duration-200"
          >
            Decline
          </button>
        </div>

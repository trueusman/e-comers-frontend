...
const getAvatar = (name: string) =>
  `https://api.dicebear.com/7.x/lorelei/svg?seed=${encodeURIComponent(name)}&backgroundColor=002f34,004d54&backgroundType=gradientLinear`;
...
export default function ProfilePage() {
  ...
  const handleAvatarChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // fallback: show preview locally if backend not running
    ...
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <div className="bg-gradient-to-r from-[#0f172a] to-[#1e293b] rounded-2xl p-6 mb-6 flex items-center gap-5 shadow-lg">
        <div className="relative flex-shrink-0">
          ...
          {/* Avatar image */}
          <img
            src={avatarUrl || getAvatar(user.name || "User")}
            alt="avatar"
            className="w-20 h-20 rounded-2xl border-4 border-[#3b82f6]/50 bg-[#001f24] object-cover"
          />
          {/* Camera button */}
          <button
